...
def EveningStoneChargesCounts(data):
    ...
    # Filter data for Service Date of 2024
    ...
    # Return counts in a similar format to MorningStoneChargesCounts
    return {
        "Hold Counts": {
            "Not 2024": hold_count_2022_2023,
            "2024": hold_count_2024
        },
        "Not Claimed Counts": {
            "Not 2024": not_claimed_count_2022_2023,
            "2024": not_claimed_count_2024
        }
    }
...
def ORG_chargesCounts(pathing):
    ...
    # Calling The function to fetch the Morning Counts
    morningFinalCounts = MorningStoneChargesCounts(data)

    # Calling The function to fetch the Evening Counts
    eveningFinalCounts = EveningStoneChargesCounts(data)

    data.to_excel(output_path, index=False)
    return output_path, morningFinalCounts, eveningFinalCounts
